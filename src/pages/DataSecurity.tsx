    ...
    return (
        <LegalPageLayout title="Data Security">
            <div className="text-lg font-medium text-gray-800 dark:text-gray-200 mb-10 border-l-4 border-primary bg-primary/5 dark:bg-primary/10 p-6 rounded-r-lg">
                At HeartSpeak, trust is not optional. It is foundational.
            </div>
            ...
            <p>
                HeartSpeak analyzes text securely using encrypted connections (HTTPS). All communication between your device and our servers is protected.
            </p>
            ...
            <p>
                HeartSpeak does not permanently store your conversation content unless explicitly required for account functionality or improvement purposes.
            </p>
            ...
            <div className="mt-12 p-6 bg-gray-50 dark:bg-white/5 rounded-lg border border-gray-100 dark:border-white/10">
                <p className="m-0">
                    If you have any questions regarding data protection, please contact us at: <a href="mailto:support@heartspeak.click" className="font-medium">support@heartspeak.click</a>
                </p>
            </div>
        </LegalPageLayout>
    );
