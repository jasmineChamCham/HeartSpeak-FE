            ...
            <div className="border-b border-border/50 p-4">
                <div className="flex items-center justify-between mb-4">
                    <Link to="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                        <img src="/logo-primary-color-without-bg.png" alt="Encantta Logo" className="h-8 w-auto object-contain mt-1" />
                        <span className="font-display text-lg font-semibold text-primary tracking-tight">Encantta</span>
                    </Link>
                    {onClose && (
