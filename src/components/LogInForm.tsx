    ...
    >
      ...
      <Button
        ...
        onClick={() => {
          ...
          document.cookie = `deviceId=${deviceId}; path=/; max-age=600`; // Save deviceId in cookie so that BE side can fetch that to login
          window.location.href = `${import.meta.env.VITE_API_URL}/auth/google?deviceId=${deviceId}`;
        }}
      >
